...
public class PreferencesActivity extends PreferenceActivity {
      ...
      switch (mChoice) {
        case 0:
          BookmarksProviderWrapper.clearHistoryAndOrBookmarks(
              PreferencesActivity.this.getContentResolver(), true, false);
          break;
        case 1:
          BookmarksProviderWrapper.clearHistoryAndOrBookmarks(
              PreferencesActivity.this.getContentResolver(), false, true);
          break;
        case 2:
          BookmarksProviderWrapper.clearHistoryAndOrBookmarks(
              PreferencesActivity.this.getContentResolver(), true, true);
          break;
        default:
          break;
      }
  ...
  private void askForRestart() {
    ApplicationUtils.showYesNoDialog(this, android.R.drawable.ic_dialog_alert,
        ...
        R.string.PreferencesActivity_RestartDialogMessage, new DialogInterface.OnClickListener() {
  ...
  private void clearHistoryBookmarks() {
    ...
    final String[] choices = new String[] {
        getString(R.string.Commons_History), getString(R.string.Commons_Bookmarks),
  ...
  private void doExportHistoryBookmarks() {
    if (ApplicationUtils.checkCardState(this, true)) {
      ...
      XmlHistoryBookmarksExporter exporter =
          new XmlHistoryBookmarksExporter(this, DateUtils.getNowForFileName() + ".xml",
  ...
  private void doImportHistoryBookmarks(String fileName) {
    ...
    if (ApplicationUtils.checkCardState(this, true)) {
      ...
      XmlHistoryBookmarksImporter importer =
          new XmlHistoryBookmarksImporter(this, fileName, mProgressDialog);
  ...
  private void exportHistoryBookmarks() {
    ApplicationUtils.showYesNoDialog(this, android.R.drawable.ic_dialog_info,
        ...
        R.string.Commons_OperationCanBeLongMessage, new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface dialog, int which) {
        dialog.dismiss();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    PreferenceCategory browserPreferenceCategory =
        (PreferenceCategory) findPreference("BrowserPreferenceCategory");
    Preference enablePluginsEclair =
        findPreference(Constants.PREFERENCES_BROWSER_ENABLE_PLUGINS_ECLAIR);
